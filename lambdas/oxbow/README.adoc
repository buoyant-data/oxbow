...
| `WITH_STATS`
| _null_ or `false`
| When set to `true` this enables inclusion of file statistics in Oxbow appends. This will include parquet file statistics in the Delta Lake table actions when adding new files.
